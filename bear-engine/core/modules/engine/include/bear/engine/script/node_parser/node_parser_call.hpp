 ...
 * \author Julien Jorge
 */
#ifndef __ENGINE_NODE_PARSER_CALL_HPP__
#define __ENGINE_NODE_PARSER_CALL_HPP__
...
namespace bear
{
  namespace engine
  {
     ...
     * \author Julien Jorge
     */
    class ENGINE_EXPORT node_parser_call:
      public node_parser
    {
    public:
      void parse_node
    ...
    }; // class node_parser_call
  } // namespace engine
} // namespace bear

#endif // __ENGINE_NODE_PARSER_CALL_HPP__
