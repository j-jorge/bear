 ...
 * \author Julien Jorge
 */
#ifndef __UNIVERSE_ALIGN_TOP_LEFT_HPP__
#define __UNIVERSE_ALIGN_TOP_LEFT_HPP__
...
namespace bear
{
  namespace universe
  {
     ...
     *        touched edge.
     */
    class UNIVERSE_EXPORT align_top_left:
      public alignment
    {
    public:
      virtual void align
    ...
    }; // class align_top_left
  } // namespace universe
} // namespace bear

#endif // __UNIVERSE_ALIGN_TOP_LEFT_HPP__
