 ...
 * \author Julien Jorge
 */
#ifndef __UNIVERSE_ALIGN_BOTTOM_RIGHT_HPP__
#define __UNIVERSE_ALIGN_BOTTOM_RIGHT_HPP__
...
namespace bear
{
  namespace universe
  {
     ...
     *        touched edge.
     */
    class UNIVERSE_EXPORT align_bottom_right:
      public alignment
    {
    public:
      virtual void align
    ...
    }; // class align_bottom_right
  } // namespace universe
} // namespace bear

#endif // __UNIVERSE_ALIGN_BOTTOM_RIGHT_HPP__
