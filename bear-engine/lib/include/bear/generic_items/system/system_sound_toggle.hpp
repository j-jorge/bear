...
/**
 * \file
 * \brief A toggle that mutes or unmutes the sounds.
 * \author Julien Jorge
 */
#ifndef __BEAR_SYSTEM_SOUND_TOGGLE_HPP__
#define __BEAR_SYSTEM_SOUND_TOGGLE_HPP__
...
namespace bear
{
   ...
   */
  class GENERIC_ITEMS_EXPORT system_sound_toggle:
    public engine::item_with_input_listener< decorative_toggle >
  {
    DECLARE_BASE_ITEM(system_sound_toggle);
...
#endif // __BEAR_SYSTEM_SOUND_TOGGLE_HPP__
