...
/**
 * \file
 * \brief A toggle that mutes or unmutes the fullscreen.
 * \author Julien Jorge
 */
#ifndef __BEAR_SYSTEM_FULLSCREEN_TOGGLE_HPP__
#define __BEAR_SYSTEM_FULLSCREEN_TOGGLE_HPP__

#include "bear/engine/base_item.hpp"
#include "bear/engine/item_brick/item_with_input_listener.hpp"

#include "bear/generic_items/decorative_toggle.hpp"
...
namespace bear
{
   ...
   */
  class GENERIC_ITEMS_EXPORT system_fullscreen_toggle:
    public engine::item_with_input_listener< decorative_toggle >
  {
    DECLARE_BASE_ITEM(system_fullscreen_toggle);
  ...
  }; // class system_fullscreen_toggle
} // namespace bear

#endif // __BEAR_SYSTEM_FULLSCREEN_TOGGLE_HPP__
