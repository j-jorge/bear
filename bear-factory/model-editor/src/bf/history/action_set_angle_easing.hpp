...
/**
 * \file
 * \brief The action of modifying the easing function for the angle.
 * \author Julien Jorge
 */
#ifndef __BF_ACTION_SET_ANGLE_EASING_HPP__
#define __BF_ACTION_SET_ANGLE_EASING_HPP__
...
namespace bf
{
   ...
   * \author Julien Jorge
   */
  class action_set_angle_easing:
    public model_action
  {
  public:
    action_set_angle_easing
...
#endif // __BF_ACTION_SET_ANGLE_EASING_HPP__
